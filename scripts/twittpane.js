...
TWITT.conf = {
  ...
  // rate_limit_status_url: TWITT.base_url+"account/rate_limit_status.json", // 1.0
  rate_limit_status_url: TWITT.base_url+"application/rate_limit_status.json", // 1.0
  ...
  // saved_searches_url: TWITT.base_url+"saved_searches.json", // 1.0
  saved_searches_url: TWITT.base_url+"saved_searches/list.json", // 1.1
  ...
  //lists_all_url: TWITT.base_url+"lists/all.json", // 1.0
  lists_all_url: TWITT.base_url+"lists/list.json", // 1.1
